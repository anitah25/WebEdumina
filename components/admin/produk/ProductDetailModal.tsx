        ...
        <div className="p-6 space-y-5">
          ...
          <div className="pt-4 border-t border-slate-100 flex items-center justify-between gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#EAF5D6] hover:bg-[#e1f0c4] text-[#437118] py-2.5 px-4 rounded-xl font-bold text-xs transition border border-[#ADD061]/20 active:scale-95"
            >
