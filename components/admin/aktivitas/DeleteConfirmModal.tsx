      ...
      <div className="bg-white rounded-3xl overflow-hidden shadow-2xl border border-slate-100 max-w-sm w-full relative z-10 animate-in fade-in zoom-in-95 duration-200">
        <div className="p-6 text-center space-y-4">
          ...
          <div className="space-y-1">
            <h3 className="font-extrabold text-slate-800 text-lg">Hapus Aktivitas?</h3>
            <p className="text-slate-500 text-sm leading-relaxed">
              Apakah Anda yakin ingin menghapus aktivitas <b>&ldquo;{activityTitle}&rdquo;</b>? Tindakan ini bersifat permanen.
            </p>
          </div>
