...
export default function ActivityFormModal({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onSave(formJudul, formTanggal, formGambar);
  };
        ...
        <div className="bg-[#1D2A62] text-white px-6 py-5 flex items-center justify-between">
          <div>
            <h3 className="font-extrabold text-lg">
              {editingActivity !== null ? "Edit Detail Aktivitas" : "Tambah Aktivitas Baru"}
            </h3>
            <p className="text-xs text-white/70 mt-0.5 font-normal">
              Isi data di bawah ini untuk memperbarui log aktivitas.
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              placeholder="Contoh: Panen Raya Lele Kolam Bioflok"
          ...
          <div className="space-y-2">
            <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider">
              Upload Gambar Dokumentasi <span className="text-slate-400 font-normal">(Opsional)</span>
            </label>
